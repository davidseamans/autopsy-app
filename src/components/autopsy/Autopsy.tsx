Warning: truncated output (original token count: 49711)
Total output lines: 4726
...
function VerdictView({
  ...
  const hasMeaningfulWeakest = !!(weakest &…19711 tokens truncated… requiredActionFallback?: string | null;
}) {
