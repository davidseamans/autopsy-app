...
const dashboardSlides = [
  ...
  { title: "Quote genuine opportunities", narration: "The Conversions card opens Quotes. There you can create a quote, see what is outstanding, accepted or rejected, and open a document to print it or save it as a PDF for email. Changing a quote to Accepted creates the job, so Jane will never do that for you." },
...
const quotesSlides = [
  ...
  { title: "Accepted and converted", narration: "Accepted shows quotes that became jobs. In the working system, changing a quote to Accepted creates the job, so Jane will never press that control for you." },
