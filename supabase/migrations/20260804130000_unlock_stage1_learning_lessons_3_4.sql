-- Extend the existing First 5 Jobs learning completion allow-list for Sprint 2.
-- This changes course availability only. It does not alter Autopsy evidence,
-- verdicts, Stage 1 access, maturity interpretation or Core admission.
