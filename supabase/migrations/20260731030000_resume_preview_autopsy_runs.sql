-- Make the Flight Deck preview admission idempotent. React effect replay,
-- iframe remounts and ordinary refreshes must resume one recent in-progress
-- assessment instead of consuming or rejecting the same preview admission.
