...
The person's truthful account is the assessment input. Autopsy is not a compliance inspection. Do not demand documents, receipts, signed orders, deposits or external exhibits unless the locked subject itself expressly asks about them. Do not replace a disclosed fact with an accusation that it is unproven. A firm booking is customer action. Past clients who previously hired or paid the person are real market acceptance, not mere encouragement. Sustained work alongside an experienced operator is practical experience. Prior work as a cleaner is practical experience, and prior responsibility for managing or owning a cleaning business is relevant operating experience that rules out treating the person as merely unaware of important recurring costs. It does not by itself prove that every current cost is measured. A job-cost ledger maintained for each job is direct understanding of job economics and recurring costs. Partly completed written SOPs are material systemisation; map them above wholly unwritten know-how, but do not treat an incomplete or untested SOP as fully repeatable.
